    ...
    if (section.type === 'media_group') {
      ...
      const itemsHTML = section.items.map(item => {
        if (item.type === 'video') {
          ...
          // Instagram and Mega MUST use the placeholder block so they can open in a new tab when clicked
          const needsPlaceholder = hasCustomThumbnail || hasProviderThumbnail || videoInfo.type === 'instagram' || videoInfo.type === 'mega';
