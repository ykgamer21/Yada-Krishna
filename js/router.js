      ...
      const itemsHTML = section.items.map(item => {
        if (item.type === 'video') {
          ...
          if (videoInfo.type === 'instagram' || videoInfo.type === 'mega') {
            // Must use placeholder because they open in a new tab
            needsPlaceholder = true;
          } else if (videoInfo.type === 'youtube' || videoInfo.type === 'dailymotion') {
            // Use placeholder because they have auto-resolved thumbnails and custom play buttons
            needsPlaceholder = true;
          } else if (hasCustomThumbnail) {
            // Use placeholder if a custom thumbnail was explicitly provided by the user
            needsPlaceholder = true;
          }
