...
window.portfolioContent = {
  ...
  STEP 1: Copy and paste this outer shell under "clientPages:" below.
  ...
  STEP 2: Paste this Media Group inside "sections: [...]" to show images/videos.
          - Set "aspectRatio" to "16:9", "9:16", "4:5", or "1:1"
          - Add 1, 2, or 3 items inside "items: [...]" (they will split into columns!)
  ------------------------------------------------------------------------
  {
    type: "media_group",
    aspectRatio: "16:9", 
    items: [
      // Format for an Image:
      { type: "image", url: "assets/works/Taruni.jpg", alt: "Project photo description" },
      
      // Format for a Video (YouTube, Vimeo, Dailymotion, Dropbox, Google Drive, OneDrive, Facebook, Instagram, Amazon S3):
      { type: "video", url: "https://www.youtube.com/watch?v=VIDEO_ID", alt: "Project video description" },
      
      // Format for a Video with a custom cover/thumbnail (Recommended for Instagram, Vimeo, Dropbox, S3):
      { type: "video", url: "https://vimeo.com/VIDEO_ID", thumbnail: "assets/works/Taruni.jpg", alt: "Video with custom cover description" }
    ]
  },
