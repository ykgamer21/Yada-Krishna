...
window.portfolioContent = {
  ...
  2. MEDIA GROUP (1, 2, or 3 items of aspect ratio "9:16" | "3:5" | "1:1" | "16:9"):
  ------------------------------------------------------------------------------------
  {
    type: "media_group",
    aspectRatio: "16:9", // Support aspect ratios: "9:16" | "3:5" | "1:1" | "16:9"
    items: [
      // Add 1, 2, or 3 items (mix images and videos)
      { type: "image", url: "assets/works/Taruni.jpg", alt: "Alt image text" },
      { type: "video", url: "https://customer-v7g3tq9n6e6b4y3c.cloudflarestream.com/YOUR_VIDEO_ID/iframe", alt: "Alt video text" }
    ]
  },
      ...
      sections: [
        {
          ...
          aspectRatio: "9:16",
          items: [
            { type: "image", url: "assets/works/Taruni.jpg", alt: "Taruni Bridal Dress 1" },
        ...
        },
        {
          ...
          aspectRatio: "16:9",
          items: [
            { type: "image", url: "assets/works/Taruni.jpg", alt: "Taruni Landscape Couture" }
          ]
        },
        {
          type: "description_box",
        ...
        },
        {
          ...
          aspectRatio: "3:5",
          items: [
            { type: "image", url: "assets/works/Taruni.jpg", alt: "Taruni 3:5 Model 1" },
            { type: "image", url: "assets/works/Furniture World.jpg", alt: "Furniture 3:5 Model 2" },
            { type: "image", url: "assets/works/Taruni.jpg", alt: "Taruni 3:5 Model 3" }
          ]
        },
        {
          type: "description_box",
